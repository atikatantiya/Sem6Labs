...
int main(void) {
    ...
    cl_mem ip_str_mem_obj = clCreateBuffer(context, CL_MEM_READ_WRITE,
    ...
    ret = clEnqueueReadBuffer(command_queue, ip_str_mem_obj, CL_TRUE, 0,
            size * sizeof(char), resStr, 0, NULL, NULL);
